# `newversion` — incoming changes

This `before/newversion` branch is a snapshot of `main` taken immediately
before merging the `newversion` line of work. It is a pre-merge reference point.

**Pull request:** https://github.com/xdic-dev/CppNCorr/pull/12

The complete description of what `newversion` introduces (verbatim from the PR
body) follows.
