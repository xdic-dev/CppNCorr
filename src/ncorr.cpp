...
namespace details {    
    ...
    bool subregion_nloptimizer::iterative_search() const {       
        ...
        // Something failed
        //std::cout << "WARNING - sr_iterative_search: Hessian probably failed; for (p1, p2) = " << params(0) << " ," << params(1) << std::endl;
        return false;
    }
...
namespace details {          
    ...
    bool analyze_point(const Array2D<double> &queue_params,
        ...
        // Something failed
        //std::cout << "WARNING - d_analyze_point failed" << std::endl;
        return false;
    }
}
...
namespace details {        
    ...
    bool recursive_nlinfo_partition_diagram(ROI2D::difference_type part_num1, 
        ...
        // Something failed
        //std::cout << "INFO - recursive nlinfo partition diagram failed " << std::endl;
        return false;   
    }
    ...
    bool analyze_point(const Array2D<double> &queue_params,
        ...
        // Something failed
        //std::cout << "INFO - sr_analyze_point failed"<< std::endl;
        return false;
    }
